        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <h1>Form Add Type of Product</h1>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <h5 class="mb-4">Add New Type of Product</h5>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endif
                            <form  action="admin/typeproduct/add" method="POST" class="mb-5">
                                ...
                                <div class="form-group">
                                    <select name="idManufacture" class="form-control">
                                        <option selected disabled> Select the Manufacture</option>
